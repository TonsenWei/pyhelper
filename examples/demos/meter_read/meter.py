...
class MeterDetection:
    def __init__(self, path):
        ...
        self.r = None  # 半径
        self.divisionValue = 8 / ((360/11)*8)  # 分度值  227.67464664405568 257.37133968458465
        # self.divisionValue = 260 / 360  # 分度值
        self.makeFiledir()
        self.markZeroPoint()
    ...
    def Readvalue(self):
        ...
        readValue = self.divisionValue * theta  # x*58.19 = 2.5    0.0429627083691356
...
if __name__ == "__main__":
    ...
    #     A.Readvalue()
    # 一张图片
    # imgpath = '001_meter.png'
    # imgpath = r'D:\projects\gits\yibiao_rec\django_yibiao\yibiao_ocr\TemplateLib\006.jpg'
    imgpath = r'D:\tmp\v3_rpm_meter.png'
    # imgpath = r'D:\tmp\v3_rpm.png'
    A = MeterDetection(imgpath)  # 鼠标点击仪表指针0点
    readValue = A.Readvalue()
    print(readValue)

    per = 11/360
    print(f"每弧度值={per}")
    print(f"2.5弧度={2.5/per}")
