...
@Time : 2022/10/4 2:25
@File : 013_music_dl.py
@Desc :
python爬取网易云音乐
https://zhuanlan.zhihu.com/p/464567005
2022-10-04 测试OK，待研究 当前目录下下载梁静茹歌曲，会有梁静茹文件夹
"""
import os
import re
import json
...
if __name__ == '__main__':
    ...
    # music_list = 'https://music.163.com/#/search/m/?order=hot&cat=全部&limit=435&offset=435&s=SHE' #搜索列表
