        ...
        while True:
            ...
            if maxval < 16000000000:  # 对匹配程度做判断
                ...
                for line in lines[0]:
                    ...
                    cv2.putText(image, lbael_text, (t_left[0], t_left[1] - 12), cv2.FONT_HERSHEY_SIMPLEX, 1,
                                (0, 255, 0), 2)
...
if __name__ == "__main__":
    img = cv2.imread(r"D:\projects\python\pylearning\examples\demos\py_opencv_meter\data\001.JPG")
    meterObj = C_ammerter(img)
    meterObj.am_run()